...
CD /D "C:\Keil\UV4"
@IF %errorlevel% NEQ 0 EXIT /b %errorlevel% 
IF NOT EXIST "\\psf\Home\Desktop\bit-shift-CY8C5667\KitProg version 2_03\KitProg\KitProg.cydsn\KitProg.svd" rem "\\psf\Home\Desktop\bit-shift-CY8C5667\KitProg version 2_03\KitProg\KitProg.cydsn\KitProg.sfr"
@IF %errorlevel% NEQ 0 EXIT /b %errorlevel% 
